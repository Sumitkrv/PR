          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              <a href="#contact" onClick={(e) => handleNavSectionClick(e, 'contact')} className="group relative overflow-hidden px-5 xl:px-6 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-purple-700 transition-all duration-400 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/30 interactive cursor-pointer">
                <span className="relative z-10 text-white font-bold text-sm flex items-center space-x-1.5 tracking-wide">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
              ...
              <div className="mt-4 pt-4 border-t border-purple-200/60">
                <a 
                  ...
                  className="w-full group px-8 py-4 bg-gradient-to-r from-[#5F4B8B] to-[#7c3aed] text-white font-bold rounded-xl hover:from-[#4b366b] hover:to-[#5F4B8B] transition-all duration-300 flex items-center justify-center min-w-[200px] shadow-lg block interactive cursor-pointer"
                >
