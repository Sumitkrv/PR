...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("access_key", "acab3dac-9aa1-4ebe-b437-f5f5b0c4f47c");
      formData.append("name", form.name);
      formData.append("email", form.email);
      formData.append("message", form.message);
      formData.append("subject", "New Contact Form Submission from PR Sparkz");
                    ...
                    <div className="flex space-x-4 mt-2">
                      {[
                        { 
                          ...
                          bgColor: 'hover:bg-gradient-to-r hover:from-pink-500 hover:to-orange-400'
                        },
                        { 
                          name: 'Facebook', 
                          icon: (
                        ...
                        <motion.a
                          ...
                          className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 bg-purple-100 text-purple-600 hover:text-white hover:shadow-lg transform hover:scale-110 ${platform.bgColor}`}
                          whileHover={{ 
                            y: -3,
                            scale: 1.15,
                          }}
